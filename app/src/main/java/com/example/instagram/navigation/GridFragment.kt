...
class GridFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        fragmentView?.gridfragment_recycleview?.adapter = UserFragmentRecycleViewAdapter()
        fragmentView?.gridfragment_recycleview?.layoutManager = GridLayoutManager(activity,3)
