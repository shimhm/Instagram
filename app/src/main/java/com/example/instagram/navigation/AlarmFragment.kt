...
class AlarmFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        view.alarmfragment_recycleview.adapter = AlarmRecycleviewAdapter()
    ...
    inner class AlarmRecycleviewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        init {
            ...
            FirebaseFirestore.getInstance().collection("alarms").whereEqualTo("destinationUid",uid).addSnapshotListener { querySnapshot, FirebaseFirestoreExect ->
                alarmDTOList.clear()
